...
type
  TOnRequestEvent = procedure(Req, Resp: TStream) of object; //add by pcplayer
  ...
  public
    IntfInfo: PTypeInfo; //moved from private to protected by pcplayer 2022-5-20
  ...
  protected
    FLinkedWebNode: TLinkedWebNode; //moved from private to protected by pcplayer 2022-5-20
    FDOMConverter:  TOPToSoapDomConvert; //moved from private to protected by pcplayer 2022-5-20

    function  GetDefaultConverter: TOPToSoapDomConvert; //moved from private to protected by pcplayer 2022-5-20
